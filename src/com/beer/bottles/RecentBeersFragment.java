...
public class RecentBeersFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int count;
		DrunkDb db = new DrunkDb(context);
		...
		if(triedBeers.length > 0){
			...
			setListAdapter(new MyCustomAdapter(context, R.layout.triedbeerrow, triedBeers));
		}else{
