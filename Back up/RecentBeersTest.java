...
public class RecentBeersTest extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(triedBeers.length > 0){
			...
			setListAdapter(new MyCustomAdapter(RecentBeersTest.this, R.layout.triedbeerrow, triedBeers));
		}else{
			setContentView(R.layout.recentbeers);
...
public class MyCustomAdapter extends ArrayAdapter<String>{
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try{
			...
			Intent myIntent = new Intent(RecentBeersTest.this, myClass);
